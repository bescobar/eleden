...
<script type="text/javascript" src="<?php echo base_url('assets/js/leaflet.extra-markers.min.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/moment.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/timeliner.min.js')?>"></script>
...
<script type="text/javascript" src="<?php echo base_url('assets/js/fullcalendar/core/main.js')?>"></script>
<script type="text/javascript" src="<?php echo base_url('assets/js/fullcalendar/daygrid/main.js')?>"></script>
